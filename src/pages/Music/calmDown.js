...
export default function CalmDown() {
  ...
  async function handleNext() {
    const nextIndex =
      songIndex + 1 >= calmDownSongs.length
        ? 0
        : songIndex + 1;
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.maincontainer}>
        ...
        <Animatable.Image
          ...
          source={calmDownSongs[songIndex].artwork}
        ...
        <Animatable.View animation="fadeInRight">
          ...
          >
            {calmDownSongs[songIndex].artist}
          </Text>
        </Animatable.View>
