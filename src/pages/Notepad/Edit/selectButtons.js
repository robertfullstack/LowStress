...
const SelectButtons = ({ route }) => {
  ...
  const { emotionId, symbol, selectedDate, todayActivity, todayFeelings, todayThoughts, todayLearn, todayGrateful, id } = route.params;
  
  const buttonContinue = (selectedButtons) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Animatable.View style={styles.footer} animation='fadeInUp'>
        <TouchableOpacity style={styles.button} onPress={() => buttonContinue(selectedButtons)}>
